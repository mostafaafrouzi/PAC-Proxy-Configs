...
> [!WARNING]
> **پروژه لغو شده (Deprecated/Read Only)**
> 
> این پروژه به دلیل خاموش شدن و مسدود شدن کامل سرورهای پروکسی رایگان (متعلق به Epic Browser) که در کدهای PAC استفاده شده بودند، **دیگر کار نمی‌کند**. سرورهای مقصد به طور کامل از روی اینترنت حذف شده‌اند و امکان اتصال به آن‌ها به هیچ وجه وجود ندارد. این مخزن تنها جهت بایگانی و خواندن (Read Only) نگهداری می‌شود.
